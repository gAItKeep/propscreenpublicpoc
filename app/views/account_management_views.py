...
@login_required
def api_v1_gait_llm_check_outer():
    print("ENTRY api_v1_gait_llm_check_outer()")
    unsafe_prompt = request.json.get("prompt")
    response = account_management_services.api_v1_gait_llm_check_inner(unsafe_prompt)
    return response, 200
